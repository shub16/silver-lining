...
AMRIPAL SEZRA 	:P2010CS1007 (tkinter)
RAMANJIT SINGH	:P2010CS1034 (pyqt)
VIKAS CHOUDHARY	:P2010CS1038 (pygtk)
NABH CHOUDHARY	:P2010CS1067 (wxpython)

------------------------------------------------------------------------------------------------------------------------------------
API Summary:-( This file contains five additional widgets spinctrl box, slider, progressbar, image widget and file_dialog)
------------------------------------------------------------------------------------------------------------------------------------
Class Windows:
...
Class ComboBox:
		...
		def __init__(self, frame, name, combo_list):pass	
