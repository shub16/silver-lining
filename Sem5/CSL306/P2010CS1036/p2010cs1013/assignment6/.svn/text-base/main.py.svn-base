...
def sampleProgram():
    ...
    if x == 1:
        import santoshreddy_pygtk as anygui
        

    #call FLTK GUI output
    elif x == 2:
        #pyFLTK_P2009CS1011.pyFLTK()
        import gauravsharma_wxpython as anygui
        
    #call pyQT GUI output
    elif x == 3:
        #pyQT_P2009CS1027.PyQt()
        import gauravsaini_pyqt as anygui
        
    #call tkinter GUI output
    elif x == 4:
       # tkinter_P2009CS1001.tkinter()
       import vikasmeena_tkinter as anygui
    ...
    Frame = anygui.Canvas(1, 'Review' ,800,500)
    ...
    Frame.add(textarea)
    sli=anygui.Slider(0,10,130,320,180,30) 
    Frame.add(sli)
    spin=anygui.SpinBox(0,10,130,360,150,30) 
    Frame.add(spin)
    #Creating Buttons
