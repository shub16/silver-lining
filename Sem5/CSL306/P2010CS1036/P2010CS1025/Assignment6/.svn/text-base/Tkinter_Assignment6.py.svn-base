...
#Action on clicking the ME Button
    ...
    valuelist = Drop_list(340,40,"Superhero",character,200,20)
    Dashboard.Add(valuelist)
...
#Adding the RadioGroup rb1
 ...
 #Creating the RadioGroup and thus Adding the radiobuttons and setting the First button true

    rb2 = Radio_button("IIT Ropar",10,325)
    rb2.Add_radio_button("IIT Delhi",10,360)
    rb2.Add_radio_button("IIT Madras",10,405)	
#Adding the RadioGroup rb2
    Dashboard.Add(rb2)
...
###########################################################
 #Dropdown valuelist
    spin=Spin_list(700,40,100,25,-10,10)
    Dashboard.Add(spin)
#Creating The Buttons "See" and "ME"
    submitBtn = Create_button(450,470,"See",120,30)
    aboutBtn = Create_button(610,470,"ME",120,30)
