...
if __name__ == '__main__':
	...
	while(b==False):					# Prompt user until he doesnt provide us with 
    	...
    	Frame = API.WindowFrame(1, 'Login ' ,400,550)		# Creating a Main window.All widgets will be added to this window.
...
# CheckBoxes for confirmation various conditions
    	checkbox1 = API.CheckBox("I understand risks in mutual funds and investments.",10,230,380,20)
    	checkbox2 = API.CheckBox("I agree to terms and conditions",10,260,380,20)
...
# Buttons widgets 
    	submitBtn = API.Button("Register",60,300,130,30)		# Button to Register
    	aboutBtn = API.Button("About",210,300,130,30)			# Button to know about the product
...
# TextArea where results will be displayed
    	textarea = API.TextArea("Click submit button to see output here!!",10,350,380,180)
    	Frame.add(textarea)
