...
# THE FUNCTION TO ADDs widgetS ON THE FRAME 
	...
	elif(widget_type==text_field or isinstance(widget,text_field2)):
            widget.suk = wx.TextCtrl(self.panel, -1, widget.label,  widget.pos, widget.size,style=wx.TE_PASSWORD )        
