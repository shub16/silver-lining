...
class Widgets(object):
	...
	def createSlider(self,x,y,height,width,minValue,maxValue,orientation):
		Slider(self,x,y,height,width,minValue,maxValue,orientation)

	def createSpinBox(self,x, y, width, minValue, maxValue):
		SpinBox(self,x,y,width,minValue,maxValue)
...
class Slider(object):
	def __init__(self,parent,x,y,height,width,minValue,maxValue,orientation):
		self.slider = Scale(parent.window, length = width, width = height, from_ = minValue, to = maxValue);
...
class SpinBox(object):
	def __init__(self,parent,x, y, width, minValue, maxValue):
		self.spinbox = Spinbox(parent.window, width = width, from_ = minValue, to = maxValue);
...
if __name__ == '__main__':    
        widget = Widgets()
        widget.setWindow(400, 300, "Tkinter GUI")
	...
	widget.createSlider(90,260,15,100,10,100,"horizontal")
	widget.createSpinBox(90,350,20,0,10)
	widget.createLabel(10,280,0,"Slider:")
	widget.createLabel(10,350,0,"Spinbox:")
        widget.endWindow()
