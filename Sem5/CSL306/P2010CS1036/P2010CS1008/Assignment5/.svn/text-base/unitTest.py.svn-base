...
if __name__ == '__main__':
    ...
    user = ShowText("Username  ",10,23,100,20);
    username = TextArea("",160,20,300,20);

    currentpasswd = ShowText("Current Password  ",10,73,100,20);
    currentpassword = PasswordField("",160,70,300,20);

    newpasswd = ShowText("New Password  ",10,123,100,20);
    passwd1 = PasswordField("",160,120,300,20);
    newpasswd1 = ShowText("Confirm Password  ",10,173,100,20);
    passwd2 = PasswordField("",160,170,300,20);

    messagebox = TextBox("",160,220,300,100);
