"""
This code generates a virtual terminal which displays the output of the each scripts written. 
...
class VirtualTerminal(vte.Terminal):				#  This class generates the virtual terminal using python vte library
